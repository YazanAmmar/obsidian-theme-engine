export default {
  ...
  colors: {
    names: {
      ...
      '--callout-default': 'Callout افتراضي',
      '--callout-info': 'Callout معلومات',
      '--callout-warning': 'Callout تحذير',
      '--callout-error': 'Callout خطأ / خطر',
      '--callout-success': 'Callout نجاح',
      '--callout-tip': 'Callout تلميح',
      '--callout-question': 'Callout سؤال',
      '--callout-important': 'Callout مهم',
      '--callout-bug': 'Callout خطأ برمجي',
      '--callout-example': 'Callout مثال',
      '--callout-quote': 'Callout اقتباس',
      '--callout-todo': 'Callout مهام',
      '--callout-summary': 'Callout ملخص',
      '--callout-fail': 'Callout فشل',
