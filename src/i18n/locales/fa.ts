export default {
  ...
  settings: {
    ...
    language: 'ترجمه‌ها و زبان‌ها',
    languageDesc:
      'زبان رابط کاربری به‌طور خودکار از تنظیمات Obsidian پیروی می‌کند. می‌توانید ترجمه‌ها را ویرایش کرده یا زبان‌های سفارشی اضافه کنید.',
  ...
  modals: {
    ...
    advancedReset: {
      ...
      settingsDesc: 'نرخ فریم، طرح‌بندی و سایر گزینه‌ها را به تنظیمات پیش‌فرض آنها بازنشانی کنید.',
