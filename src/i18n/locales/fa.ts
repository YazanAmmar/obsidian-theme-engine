export default {
  ...
  modals: {
    ...
    advancedReset: {
      ...
      backgroundsDesc:
        'پوشهٔ پس‌زمینه‌ها را در پوشهٔ تنظیمات Obsidian (configDir/backgrounds) به‌طور کامل همراه با تمامی رسانه‌ها حذف می‌کند.',
  ...
  colors: {
    names: {
      ...
      '--callout-default': 'Callout پیش‌فرض',
      '--callout-info': 'Callout اطلاعات',
      '--callout-warning': 'Callout هشدار',
      '--callout-error': 'Callout خطا / خطر',
      '--callout-success': 'Callout موفقیت',
      '--callout-tip': 'Callout نکته',
      '--callout-question': 'Callout پرسش',
      '--callout-important': 'Callout مهم',
      '--callout-bug': 'Callout باگ',
      '--callout-example': 'Callout مثال',
      '--callout-quote': 'Callout نقل‌قول',
      '--callout-todo': 'Callout کارها',
      '--callout-summary': 'Callout خلاصه',
      '--callout-fail': 'Callout شکست',
